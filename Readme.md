...
<body bgcolor="palegoldenrod">
    ...
    <br><br>
    <h2><u style="color:blue;">Team Name:</u>
        <br>TheAiPeople
        <br><br>
        <u style="color:blue;">Theme:</u>
        <br> A Search Engine for education.
        <br><br>
        <u style="color:blue;">How will we solve the problem?</u>
        <br> We mostly use the concept of web scraping to provide the results of the searches in the engine. The programming language used is Python
        ...
        <br><br>
        <u style="color:blue;">What will be our Final Demo?</u>
        <br>A search Engine which focuses only on providing educational resources to users. The resources will be
